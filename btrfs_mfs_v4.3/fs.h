...
// dat: add fixed location with 332KB and 664KB for superblock instead of 64MB and 256GB
#define BTRFS_SUPER_INFO_OFFSET_1      (339968)
#define BTRFS_SUPER_INFO_OFFSET_2        (679936)
#define BTRFS_SUPER_INFO_COUNT			64
...
// dat: adding an array of btrfs_fs_info to store the fs_info of the multiple superblocks
struct btrfs_fs_info {
	// dat: adding an array of superblocks to store the superblocks of the multiple superblocks
    int id;
    struct btrfs_fs_info *fs_info_array[BTRFS_SUPER_INFO_COUNT];
