			  ...
			  struct btrfs_key *key, int slot)
{
    ...
    //printk(KERN_INFO "check_dev_item: Enter to check\n");
    ...
    //printk(KERN_INFO "check_dev_item: Check device_bytes_used\n");
    ...
    //printk(KERN_INFO "check_dev_item: Pass device_bytes_used\n");
	/*
