...
int btrfs_commit_transaction(struct btrfs_trans_handle *trans)
{
    ...
    //printk(KERN_INFO "btrfs_commit_transaction: start committing transaction\n");
    ...
    //printk(KERN_INFO "btrfs_commit_transaction: start delalloc\n");
	if (ret)
		goto lockdep_release;
    ...
    //printk(KERN_INFO "btrfs_commit_transaction: done starting delalloc\n");
	 ...
	 * delayed item
	 */
    //printk(KERN_INFO "btrfs_commit_transaction: Call to btrfs_assert_delayed_root_empty of fs_info %d\n", fs_info->id);
	...
	ret = commit_cowonly_roots(trans);
    //printk(KERN_INFO "btrfs_commit_transaction: done commit cowonly_roots\n");
	if (ret)
		goto unlock_reloc;
    ...
    //printk(KERN_INFO "btrfs_commit_transaction: done writing and waiting transaction\n");

	ret = write_all_supers(fs_info, 0);
    //printk(KERN_INFO "btrfs_commit_transaction: done writing supers\n");
	/*
    ...
    //printk(KERN_INFO "btrfs_commit_transaction: finish extent commit\n");
