...
static void btrfs_check_read_bio(struct btrfs_bio *bbio, struct btrfs_device *dev)
{
	...
	while (iter->bi_size) {
        ...
        //printk(KERN_INFO "btrfs_check_read_bio: Entering data_csum\n");
...
static void btrfs_end_bio_work(struct work_struct *work)
{
	...
	if (is_data_bbio(bbio)) {
        //printk(KERN_INFO "btrfs_end_bio_work: This is case of data bio, so enter checking read bio\n");
...
static void btrfs_simple_end_io(struct bio *bio)
{
	...
	if (bio_op(bio) == REQ_OP_READ) {
        ...
        //printk(KERN_INFO "btrfs_simple_end_io: Queue bio->btrfs_end_bio_work\n");
	} else {
			       ...
			       struct btrfs_io_stripe *smap, int mirror_num)
{
	if (!bioc) {
        ...
        //printk(KERN_INFO "__btrfs_submit_bio: Entering simple_end_io\n");
...
static bool btrfs_submit_chunk(struct btrfs_bio *bbio, int mirror_num)
{
    ...
    //printk(KERN_INFO "btrfs_submit_chunk: Entering submit_chunk\n");
	...
	if (btrfs_op(bio) == BTRFS_MAP_WRITE) {
		...
		if (inode && !(inode->flags & BTRFS_INODE_NODATASUM) &&
            ...
            //printk(KERN_INFO "btrfs_submit_chunk: Do bio checksum\n");
    ...
    //printk(KERN_INFO "btrfs_submit_chunk: Entering __submit_bio\n");
