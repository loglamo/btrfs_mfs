...
KTDEF(btrfs_qgroup_reserve_meta_prealloc);
KTDEF(btrfs_reserve_metadata_bytes);
				    ...
				    u64 disk_num_bytes, bool noflush)
{
	...
	ret = btrfs_qgroup_reserve_meta_prealloc(root, qgroup_reserve, true,
						 noflush);
    ktget(&localclock[1]);
    ktput(localclock, btrfs_qgroup_reserve_meta_prealloc);
    ...
    ktget(&localclock[1]);
    ktput(localclock, btrfs_reserve_metadata_bytes);
	if (ret) {
