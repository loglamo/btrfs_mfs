...
int btrfs_sb_log_location_bdev(struct block_device *bdev, int mirror, int rw,
			       u64 *bytenr_ret);
int btrfs_sb_log_location_bdev_partition(struct block_device *bdev,
					     int mirror, int rw, u64 *bytenr_ret, u64 sb_offset);
int btrfs_sb_log_location(struct btrfs_device *device, int mirror, int rw,
			  u64 *bytenr_ret);
int btrfs_sb_log_location_partition(struct btrfs_device *device, int mirror,
					int rw, u64 *bytenr_ret, u64 sb_offset);
...
// dat: this function is called from btrfs_mount_root()->btrfs_scan_one_device()
static inline int btrfs_sb_log_location_bdev_partition(struct block_device *bdev,
					     int mirror, int rw, u64 *bytenr_ret, u64 sb_offset)
{
	*bytenr_ret = btrfs_sb_offset_partition(mirror, sb_offset);
	return 0;
}
...
static inline int btrfs_sb_log_location_partition(struct btrfs_device *device, int mirror,
					int rw, u64 *bytenr_ret, u64 sb_offset)
{
	*bytenr_ret = btrfs_sb_offset_partition(mirror, sb_offset);
	return 0;
